      ...
      >
        ...
        <div className="w-full h-full">
          <picture>
            ...
            <source
              ...
              srcSet="https://via.placeholder.com/1600x900.png?text=Large+Screen+Image+1"
            />
          ...
          <div className="absolute inset-0 flex flex-col justify-center items-center text-white bg-black bg-opacity-50">
            ...
            <p className="text-md md:text-lg p-2">
        ...
        <div className="w-full h-full">
          <picture>
            <source
              media="(min-width: 1024px)"
              srcSet="https://via.placeholder.com/1600x900.png?text=Large+Screen+Image+2"
            />
            <img
              src={bannerm1}
              alt="Slide 2"
